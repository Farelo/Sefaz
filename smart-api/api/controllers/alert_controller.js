...
/**
 * List of Alerts with pagination to especific packing type
 */
exports.alert_list_packing = function (req, res) {
...
/**
 * List of Alerts pagination to especific packing type by logistic operator
 */
exports.alert_list_packing_logistic = function (req, res) {
  let project = req.swagger.params.project.value;
  let code = req.swagger.params.code.value;
  let supplier = req.swagger.params.supplier.value;
  let status = req.swagger.params.status.value;
