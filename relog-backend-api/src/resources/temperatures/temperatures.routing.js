...
router.get("/", [], temperaturesController.get);
router.get("/last", [], temperaturesController.getLast);
 ...
 * /temperatures:
 *   get:
 *     summary: Retrieve the temperatures of all devices with position messages in the specified period of time
