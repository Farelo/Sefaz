...
exports.user_auth = function(req, res) {
  user.find({'password': req.swagger.params.password.value,'email': req.swagger.params.email.value})
    .then(_.partial(successHandler, res))
...
exports.user_listPagination = function(req, res) { 
  user.paginate(req.swagger.params.attr.value ? {"name": req.swagger.params.attr.value, 'profile': 'AdminFactory'} : {'profile': 'AdminFactory'} , {
