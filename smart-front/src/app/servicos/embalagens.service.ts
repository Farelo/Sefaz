...
export class EmbalagensService {
  ...
  private embalagens: any[] = [
    {id: 1, nome: 'Embalagem1', descricao: 'Lorem ipsum dolor sit amet', duns: '50', fornecedor: '086', ultimaAtualizacao: '12/12/12', status: 'atrasado'},
    ...
    {id: 4, nome: 'Embalagem4', descricao: 'Lorem ipsum dolor sit amet', duns: '50', fornecedor: '086', ultimaAtualizacao: '12/12/12', status: 'atrasado'},
  ...
  getLista(id: number){
    for (let i=0; i<this.embalagens.length; i++){
      let embalagem = this.embalagens[i];
      if (embalagem.duns == id){
        this.embalagensLista.push(embalagem);
      }
    }
    return this.embalagensLista;
  }
