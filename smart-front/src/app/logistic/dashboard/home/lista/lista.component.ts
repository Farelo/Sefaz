...
export class ListaComponent implements OnInit {
  ...
  getAlerts(){
    let array = (this.auth.currentUser().logistic ? this.auth.currentUser().logistic.suppliers : this.auth.currentUser().official_logistic.suppliers);

    this.AlertsService.getAlertsPaginationByHashingLogistic(10,this.data.meta.page,this.code,this.project,this.supplier,this.status,array)
